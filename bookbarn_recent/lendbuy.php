...
<?php  
                $query = "SELECT `id`,`Image`, `Title`, `Category`, `Description`, `Price`, `Phonenumber`, `Email`, `Location`  FROM `lend` order by id ";  
      ...
      <div method="post" action="lendbuy.php?action=id=<?php echo $row["id"]; ?>"> 
    ...
    <div class=" col-md-3   column productbox" >
      ...
      <div class="productprice"><div class="pull-right"><a href="lendviewfunction.php?action=buy&id=<?php echo $row["id"]; ?>&email=<?php echo $email ?>" class="btn btn-danger btn-sm" role="button">VIEW</a></div><div class="pricetext">Rs. <?php echo $row["Price"]; ?> /day</div></div>
    </div>
      </div>
